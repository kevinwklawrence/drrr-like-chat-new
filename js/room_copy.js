                ...
                try {
                    ...
                    if (!Array.isArray(messages)) {
                        ...
                        messages.forEach(msg => {
                            ...
                            html += `
                            <div class="chat-message col-md d-flex container">
                            <p>
                                    <div class="col-md-1" id="profile"><div id="avataricon"><img src="images/${avatar}" width="58" alt="${name}'s avatar" style="vertical-align: middle;"></div>
                                    ...
                                    <div class="col-md message" id="${avatarClass}"><p>${msg.message}</p></div>
                                </p></div>`;
                            if (isAdmin) {
